...
namespace ShopAdmin.Migrations
{
    ...
    [Migration("20240302112135_pieVerison")]
    partial class pieVerison
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShopAdmin.Models.Ingredient", b =>
                {
            ...
            modelBuilder.Entity("ShopAdmin.Models.OrderDetail", b =>
                {
            ...
            modelBuilder.Entity("ShopAdmin.Models.Pie", b =>
                {
                    b.Property<int>("PieId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ShopAdmin.Models.Ingredient", b =>
                {
                    b.HasOne("ShopAdmin.Models.Pie", null)
            ...
            modelBuilder.Entity("ShopAdmin.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("ShopAdmin.Models.Pie", "Pie")
                        .WithMany()
                        .HasForeignKey("PieId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
